...
seattle_attrib_pri.reset_index(inplace=True)
seattle_attrib_sec.reset_index(inplace=True)
seattle_attrib_combo = seattle_attrib_pri.copy()
seattle_attrib_combo['Bold'] = (seattle_attrib_pri['Bold'] + seattle_attrib_sec['Bold'])/2
# seattle_attrib_combo['Bold'] = (seattle_attrib_pri['Bold'] + seattle_attrib_sec['Bold'])/2
seattle_attrib = seattle_attrib_pri.copy()


seattle_attrib['Bold'] = np.where(seattle_attrib_sec['Bold']==None, seattle_attrib_pri['Bold'],                                   (seattle_attrib_combo['Bold']))

# seattle_attrib['Bold'] = seattle_attrib['Bold'] if (seattle_attrib_sec['Bold'] == None) else \
# ((X['Bold'] + seattle_attrib_sec['Bold']) / 2))

# seattle_attrib['Bold'] = seattle_attrib['Bold'].apply(lambda X: X['Bold'] if (seattle_attrib_sec['Bold'] == None) else \
# ((X['Bold'] + seattle_attrib_sec['Bold']) / 2))
# seattle_attrib.head(20)
seattle_registry
